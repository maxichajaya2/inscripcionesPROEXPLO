...
// Importamos tus estilos globales (Asegúrate de cambiar bg-gradient-wmc por bg-gradient-proexplo en tu CSS)
...
<template>
    ...
    <Head title="Iniciar Sesión | Proexplo" />

    <div class="min-h-screen bg-gradient-proexplo flex items-center justify-center p-4 relative overflow-hidden font-sans">
        ...
        <div
            ...
            <div class="h-2 w-full bg-gradient-to-r from-orange-600 via-amber-500 to-orange-600"></div>

            <div class="p-8 sm:p-10">

                <div class="text-center mb-8">
                    <a href="https://proexplo.com.pe/es" rel="noopener noreferrer"
                        class="inline-block mb-5 transition-transform hover:scale-105">
                        <img src="/images/logo-proexplo.png" alt="Proexplo"
                    ...
                    <p class="text-sm font-bold text-slate-400 tracking-widest mt-1">Ingrese sus credenciales</p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" v-model="form.email" required autofocus
                                autocomplete="username" placeholder="admin@proexplo.com.pe"
                                class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all outline-none text-sm font-medium text-slate-700 placeholder-slate-400" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" :type="showPassword ? 'text' : 'password'" v-model="form.password" required
                                ...
                                class="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all outline-none text-sm font-medium text-slate-700 placeholder-slate-400" />
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <input type="checkbox" v-model="form.remember"
                                class="w-3.5 h-3.5 rounded border-slate-300 text-orange-600 focus:ring-orange-500 transition-colors" />
                            <span
                                class="text-[11px] font-bold text-slate-500 group-hover:text-slate-700 transition-colors">Recordarme</span>
                        </label>

                        <Link v-if="canResetPassword" :href="route('password.request')"
                            class="text-[11px] font-bold text-orange-600 hover:text-orange-800 transition-colors">
                    ...
                    <div class="pt-3">
                        <button type="submit" :disabled="form.processing"
                            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-black rounded-xl text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-orange-500/50 transition-all active:scale-95 shadow-md shadow-orange-200 overflow-hidden disabled:opacity-70">
