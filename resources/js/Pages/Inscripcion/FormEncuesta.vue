...
<template>
    ...
    <div class="max-w-6xl mx-auto px-6 py-12 font-sans">
        ...
        <div class="border border-pro-orange/20 rounded-[2rem] p-8 mb-12 flex flex-col md:flex-row items-center gap-6 bg-white shadow-sm">
                ...
                <form @submit.prevent="enviarFormulario" class="max-w-4xl mx-auto space-y-8">
                        ...
                        <div class="md:col-span-5">
                            ...
                            <div class="flex gap-3">
                                <div class="relative bg-white/95 text-slate-900 rounded-full px-5 py-4 flex items-center gap-2 font-bold shadow-inner">
                                    ...
                                    <select v-model="paisSeleccionado" class="absolute inset-0 opacity-0 cursor-pointer w-full h-full">
                    ...
                    <div class="flex justify-center md:justify-start pt-6">
                        <button type="submit" :disabled="!formularioValido || loading"
                            :class="!formularioValido || loading ? 'opacity-40 cursor-not-allowed scale-95' : 'hover:scale-105 shadow-[0_10px_30px_rgba(226,122,17,0.3)]'"
                            class="relative overflow-hidden group bg-pro-orange text-white font-black py-5 px-16 rounded-full transition-all duration-500 uppercase tracking-[0.15em] text-sm flex items-center gap-2">
