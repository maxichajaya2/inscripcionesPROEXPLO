...
class WebServiceController extends Controller
{
    public function __construct()
    {
        ...
        $this->url_list_type = "https://secure2.iimp.org:8443/KBServiciosIIMPJavaEnvironment/rest/listpasstype";
    }
    ...
    public function wsInscripcion_WMC_2026($facturacion, $persona, $inscripcion, $niubiz)
    {
        try {
            ...
            $perfil_real = $inscripcion->id_perfil;
            ...
            if ($inscripcion->id_categoria_inscripcion) {
                ...
                $perfil_real = ($precio_cat && $precio_cat->pivot) ? $precio_cat->pivot->id_perfil : 5;
    ...
    public function wsMultieventos_PROEXPLO($facturacion, $persona, $inscripcion, $niubiz)
    {
    ...
    public function wsListPasstype()
    {
        $response = $this->sendWS($this->url_list_type, json_encode([]));

        if (isset($response->passTypes)) {
            return $response->passTypes;
        }
